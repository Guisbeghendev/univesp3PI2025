...
@section('content')
                    ...
                    <div class="bg-gray-200 p-4">
                        ...
                        <form action="{{ route('perfil.updatePerfil') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="nome" value="{{ old('nome', $perfil ? $perfil->nome : '') }}" class="input w-full">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="date" name="data_nascimento" value="{{ old('data_nascimento', $perfil ? $perfil->data_nascimento : '') }}" class="input w-full">
                            </div>
                            <div>
                                <label class="block font-semibold">Biografia</label>
                                <textarea name="biografia" rows="4" class="input w-full">{{ old('biografia', $perfil ? $perfil->biografia : '') }}</textarea>
                            </div>
                            <div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const estadoSelecionado = "{{ old('estado', $perfil ? $perfil->estado : '') }}";
            const cidadeSelecionada = "{{ old('cidade', $perfil ? $perfil->cidade : '') }}";
